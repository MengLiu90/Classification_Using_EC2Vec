...
df = pd.read_csv('embedded_substrates_ECs_data.csv')
...
joblib.dump(rf_classifier, 'substrate_ec_classifier_trained_model.pkl')

# # load the trained model
# rf_classifier = joblib.load('substrate_ec_classifier_trained_model.pkl')
